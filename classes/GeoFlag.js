 ...
 */
class GeoFlag extends GeoAbstract_1.GeoAbstract {
  static flags = {
  ...
  /**
     ...
     */
  get (code) {
    return (0, vue_1.computed)(() => this.getStatic((0, ref_1.getRef)(code)))
  }
  ...
  /**
     ...
     */
  getStatic (code) {
    const data = Geo_1.Geo.getDataByCode(Geo_1.Geo.toCountry(code || this.code.value))
    if (data) {
  ...
  /**
     ...
     */
  getFlag (code) {
    return (0, vue_1.computed)(() => this.getFlagStatic((0, ref_1.getRef)(code)))
  }
  ...
  /**
     ...
     */
  getLanguage (data) {
    return data ? this.intl.languageStatic(data.language) : ''
  }
  ...
  /**
     ...
     */
  getCountry (data) {
    return data ? this.intl.countryNameStatic(data.country) : ''
  }
  ...
  /**
     ...
     */
  getList (codes) {
    return (0, data_1.forEach)(GeoFlag.getCodes(codes), code => this.get(code))
  }
  ...
  /**
     ...
     * @param codes country code / код страны
     */
  static getNational (codes) {
    return (0, data_1.forEach)(GeoFlag.getCodes(codes), code => new GeoFlag(code).get())
  }
  ...
  /**
     ...
     * @param codes country code / код страны
     */
  static getCodes (codes) {
    return (0, ref_1.getRef)(codes) || Object.keys(GeoFlag.flags)
  }
}
exports.GeoFlag = GeoFlag
// # sourceMappingURL=GeoFlag.js.map
